...
public class Main {
    public static void main(String[] args) {
        ...
        max.printOut();
        Human vova = new Human(LocalDate.now().getYear()-21,"Владимир", "Казань", "");
        vova.printOut();

        System.out.println("Задание 2");
        Flower rozaObyknovennaya = new Flower("Роза обыкновенная","", "Голландия", 35.59, 0);
        Flower hrizantema = new Flower("Хризантема","", "", 15.0, 5);
        ...
        Flower[] buket = {rozaObyknovennaya, rozaObyknovennaya, hrizantema, pion, pion, gipsofila};
        Flower.calcCostAndLifeSpan(buket);
